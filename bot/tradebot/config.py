...
HL_MIN_NOTIONAL_USD = 10.0                           # exchange minimum per order
HL_ORDER_USD = float(env("HL_ORDER_USD", "15"))     # a 75% partial cover must itself clear $10
...
PRICE_CACHE_READ_PER_M = float(env("PRICE_CACHE_READ_PER_M", "0.5"))
PRICE_CACHE_WRITE_PER_M = float(env("PRICE_CACHE_WRITE_PER_M", "10"))
