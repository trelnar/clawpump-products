...
umask 077
{
  ...
  grep -E '^(ANTHROPIC_API_KEY|ANTHROPIC_WORKSPACE_ID|ANTHROPIC_MODEL|DISCOVERY_INTERVAL_SEC|TRADEBOT_DB|SOLANA_RPC|BASE_RPC|TRADEBOT_LOG_STDOUT|NEYNAR_API_KEY|BIRDEYE_API_KEY|(AGENT|SIGNAL|PAID_PROMO|REDDIT|TG|GECKO|PUMPFUN|HL|SHORTS|RUG|SIM|BUY|P30)_[A-Z0-9_]*)=' "$SECRETS" || true
} > "$AGENT_ENV"
